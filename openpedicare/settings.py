...
LINEBOT_PUBLIC_BASE_URL = os.getenv("LINEBOT_PUBLIC_BASE_URL", "")
LINEBOT_REPLY_ENDPOINT = os.getenv("LINEBOT_REPLY_ENDPOINT", "https://api.line.me/v2/bot/message/reply")
LINEBOT_REQUIRE_SIGNATURE = env_bool("LINEBOT_REQUIRE_SIGNATURE", True)
LINEBOT_ONLY_APPROVED_VISITS = env_bool("LINEBOT_ONLY_APPROVED_VISITS", False)
LINEBOT_MAX_REPLY_CHARS = int(os.getenv("LINEBOT_MAX_REPLY_CHARS", "3600"))
LINEBOT_HTTP_TIMEOUT_SECONDS = int(os.getenv("LINEBOT_HTTP_TIMEOUT_SECONDS", "8"))
